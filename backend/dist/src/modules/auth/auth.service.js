...
let AuthService = class AuthService {
    constructor(userRepo, schoolRepo, jwtService) {
        this.userRepo = userRepo;
        this.schoolRepo = schoolRepo;
        this.jwtService = jwtService;
    }
    async register(dto) {
        if (dto.role !== roles_enum_1.Role.SUPER_ADMIN && !dto.schoolId) {
            throw new common_1.BadRequestException('برای این نقش، مدرسه الزامی است');
        }
