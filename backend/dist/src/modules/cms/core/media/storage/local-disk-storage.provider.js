...
let LocalDiskStorageProvider = class LocalDiskStorageProvider {
    constructor(configService) {
        this.configService = configService;
        const configuredPath = this.configService.get('MEDIA_LOCAL_PATH');
...
exports.LocalDiskStorageProvider = LocalDiskStorageProvider = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [config_1.ConfigService])
], LocalDiskStorageProvider);
//# sourceMappingURL=local-disk-storage.provider.js.map