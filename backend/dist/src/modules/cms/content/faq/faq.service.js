...
let FaqService = class FaqService extends base_content_service_1.BaseContentService {
    constructor(repository, revisionsService, events, publishingService, orderingService, localeResolverService) {
        super(repository, cms_entity_type_enum_1.CmsEntityType.FAQ, revisionsService, events);
