...
exports.NavigationPublicController = void 0;
...
let NavigationPublicController = class NavigationPublicController {
    constructor(navigationService) {
        this.navigationService = navigationService;
    }
    async findTree(site, query) {
        return this.navigationService.findPublishedTree(site.id, query.locale);
    }
};
exports.NavigationPublicController = NavigationPublicController;
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, public_site_context_decorator_1.PublicSiteContext)()),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [site_entity_1.Site, navigation_item_query_dto_1.PublicNavigationQueryDto]),
    __metadata("design:returntype", Promise)
], NavigationPublicController.prototype, "findTree", null);
exports.NavigationPublicController = NavigationPublicController = __decorate([
    (0, common_1.Controller)('public/navigation'),
...
], NavigationPublicController);
//# sourceMappingURL=navigation-public.controller.js.map