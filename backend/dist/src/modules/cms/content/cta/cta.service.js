...
let CtaService = class CtaService extends base_content_service_1.BaseContentService {
    constructor(repository, revisionsService, events, publishingService, orderingService, localeResolverService) {
        super(repository, cms_entity_type_enum_1.CmsEntityType.CTA, revisionsService, events);
...
exports.CtaService = CtaService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(cta_entity_1.Cta)),
