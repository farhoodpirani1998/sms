 ...
 * expected to be removed from this list (and deleted) once CMS-D.1
 * lands and has a real content type to prove the pattern against instead
 * — `PublishingModule`/`OrderingModule` stay, since every real content
 * type needs them too.
 *
 * The rest of `core/*` (seo, i18n, public-api) and the 14 real
